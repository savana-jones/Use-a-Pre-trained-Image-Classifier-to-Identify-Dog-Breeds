...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        if results_dic[key][2] == 1:
            ...
            # 5a: Count correctly classified breeds
        ...
        # 5b: Count correctly classified NOT-a-dog images
        else:
            if results_dic[key][4] == 0:  # Classifier classifies as not-a-dog
    ...
    # 5c: Calculate % of correctly matched images
    results_stats_dic['pct_match'] = (results_stats_dic['n_match'] / results_stats_dic['n_images']) * 100.0

    # 5d: Calculate % of correctly classified dog images
    ...
    # 5e: Calculate % of correctly classified breeds of dogs
    if results_stats_dic['n_dogs_img'] > 0:
