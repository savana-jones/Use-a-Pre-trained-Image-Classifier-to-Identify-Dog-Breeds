...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for key in results_dic:
        if results_dic[key][0] in dognames_dic:
            ...
            # 4c. Add (1,0) to the results_dic dictionary for the key indicated by the 
            ...
            # 4e. Add (0,0) to the results_dic dictionary for the key indicated by the 
            #     variable key. This indicates the pet label is-NOT-a-dog, classifier label is-NOT-a-dog.
            else:
